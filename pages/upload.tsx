            ...
            <div className="bg-[#F8F8F8] rounded-lg h-[90vh] md:h-[70vh] w-[60%] flex gap-6 flex-wrap items-center p-6 mdd:p-14 pt-6 justify-around">
                <div>
                    <div>
                        ...
                        <p className="text-xs sm:text-md text-gray-400 mt-1">
                    ...
                    <div
                        className="border-dashed rounded-xl border-4 border-gray-200 flex flex-col justify-center
                            items-center outline-none mt-10 w-[140px] xs:w-[180px] sm:w-[260px] h-[400px] mdd:h-[460px] p-10 cursor-pointer hover:border-red-300
                            hover:bg-gray-100"
                    >
                        {
                            isLoading
                                                        ...
                                                        <div className="flex flex-col items-center justify-center h-full">
                                                            <div className="flex flex-col items-center justify-center">
                                                                <p className="font-bold text-xl">
                                                                    <FaCloudUploadAlt
                                                                        className="text-gray-300 text-5xl sm:text-6xl"
                                                                    />
                                                                </p>
                                                            ...
                                                            <p className="text-gray-400 text-center mt-10 text-xs sm:text-sm leading-10">
                                                                MP4 or WebM <br />
                                                                720x1280 or Higher <br />
                                                                Up to 10 Minutes <br />
                                                                Less Than 2GB
                                                            </p>
                                                            <p className="bg-[#F51997] text-center mt-10 rounded text-white text-md font-medium p-2 w-[110px] sm:w-52 outline-none">
                                                                Select File
                                                            </p>
                                                            <input
                                                                type="file"
                ...
                <div className="flex flex-col gap-3 pb-10 xxs:w-full">
